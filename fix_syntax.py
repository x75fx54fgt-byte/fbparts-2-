...
start_idx = content.find("window.imprimirCierreMensual = function(formato) {")
end_idx = content.find("window.cargarHistorialReventas = async function() {")

if start_idx == -1 or end_idx == -1:
    print("Could not find boundaries")
    exit(1)

new_func = """window.imprimirCierreMensual = function(formato) {
