            ...
            try {
                ...
                prodSnap.forEach(docSnap => {
                    ...
                    if(tablaProd) {
                        ...
                        let bMod = '';
                        if(prod.modalidad && prod.modalidad.toLowerCase().includes("
            ...
            return `
                <div style="max-width: 800px; margin: 0 auto; background: white; padding: 25px; font-family: Arial, sans-serif; color: #333; box-sizing: border-box; width: 100%;">
                    ...
                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 12px; font-size: 11px;">
                        <thead>
                            <tr style="background-color: #385723 !
        ...
        window.imprimirFacturaCarta = function(fac, ventanaExterna = null) {
            ...
            const finalStyle = '<style>body{background:white;margin:0;padding:20px;-webkit-print-color-adjust:exact!
        ...
        window.cargarHistorialFacturas = async function() {
            ...
            try {
                ...
                snap.forEach(docSnap => {
                    ...
                    else if (estatus.includes("Importación")) colorClase = 'status-
        ...
        window.cargarHistorialImportaciones = async function() {
            ...
            if(!tbody) return;
            tbody.innerHTML = `<tr><td colspan="6" style="text-align: center;">Cargando historial...</td></tr>`;
            if(selectLanded) selectLanded.innerHTML = '<option value="">Selecciona un cálculo de 
            ...
            try {
                ...
                console.error("Error cargando historial de 
            }
        };
        ...
        window.actualizarEstatusDocumento = async function(docId, tipoDocumento, selectElement) {
            ...
            else if (nuevoEstatus.includes("Importación")) { colorClase = 'status-
...
window.cargarHistorialFacturas = async function() {
    ...
    window.actualizarNotificacionesCobranza();
        ...
        window.generarDescripcionIA = async function() {
            ...
            [Redacta aquí 2 o 3 líneas atractivas explicando brevemente para qué sirve esta pieza en el vehículo y por qué es 
    ...
    filas.forEach(fila => {
        ...
        window.imprimirCierreMensual = function(formato) {
            ...
            w.document.close(); setTimeout(() => { w.focus(); w.print(); w.close(); }, 500);
        };
