...
target = """        window.guardarReventa = async function() {
            ...
            try {
                ...
                // Si la ganancia neta en el dashboard está conectada, esto la actualiza:
                if (window.calcularGananciaNetaDashboard) {
                    await window.calcularGananciaNetaDashboard(window.tasaVivaBCV, window.tasaVivaEUR);
                }
...
if target in content:
    ...
    print("Not found! Let's search again.")
